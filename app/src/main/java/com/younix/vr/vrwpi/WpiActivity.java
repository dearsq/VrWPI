...
/**
 *
This is VR App developping on Google Cardboard VR SDK.
The Targets:
1. Play Video.
2. Link to LeCloud.
3. Vod the Video which on the LeCloud.
4. Performs VR.
 */
 ...
 *     --ei inputType 2
 */
public class WpiActivity extends Activity {
    private static final String TAG = WpiActivity.class.getSimpleName();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wpi);
    ...
    private class ActivityEventListener extends VrVideoEventListener  {
        ...
        public void onLoadError(String errorMessage) {
            ...
            Toast.makeText(
                    WpiActivity.this, "Error loading video: " + errorMessage, Toast.LENGTH_LONG)
                    .show();
        ...
        protected Boolean doInBackground(Pair<Uri, Options>... fileInformation) {
            try {
                ...
                videoWidgetView.post(new Runnable() {
                    ...
                    public void run() {
                        Toast
                                .makeText(WpiActivity.this, "Error opening file. ", Toast.LENGTH_LONG)
                                .show();
                    }
                });
